...
// Supports both delimiter-based and JSON-formatted data.
  ...
  parser.on('data', async (line) => {
    ...
    if (parsed) {
      ...
      // Handle JSON-based input
        ...
        // If a complete JSON object is received, process it as a whole.
        // You may choose a key (for example, Time) as a marker for a complete dataset.
